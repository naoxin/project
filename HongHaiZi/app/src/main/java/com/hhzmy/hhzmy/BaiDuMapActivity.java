...
import static com.ehhzmy.hhzmy.R.id.di;
...
//            }
            ...
            if (list != null) {
                ...
                // 设置结果，并进行传送
                BaiDuMapActivity.this.setResult(requestCode, mIntent);

            }
            Log.i("BaiduLocationApiDem", sb.toString());
            Toast.makeText(BaiDuMapActivity.this, "经度:"+lotitude.toString()+"纬度:"+longitude.toString(), Toast.LENGTH_SHORT).show();
        }
    }
    @Override
